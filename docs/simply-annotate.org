...
7. Press M-s [ to cycle through annotation levels (file, defun, line)
...
:CLASS: section
:END:
All annotation overlay markers (highlights and fringe indicators) remain
visible regardless of the active level. Only /interaction/ is filtered
to the active level:

- *Navigation*: M-n and M-p skip annotations that don't match the active
  level.
...
- *Visual markers*: All overlays from all levels remain visible at all
  times.
...
:CLASS: section
:END:
Press M-s [ to cycle through levels:

#+begin_src example-preformatted
file ⇒ defun ⇒ line ⇒ file ⇒ ...
#+end_src

The header-line updates to show the active level as =[FILE]=, =[DEFUN]=,
or =[LINE]= along with the annotation count for that level.
...
| M-s [ | =simply-annotate-cycle-level=              | Cycle through annotation levels      |
| M-n   | =simply-annotate-next=                     | Jump to next annotation              |
| M-p   | =simply-annotate-previous=                 | Jump to previous annotation          |
...
|                | [[#index-simply_002dannotate_002dcycle_002dlevel][=simply-annotate-cycle-level=]]                               | [[#Annotation-Levels][Annotation Levels]]                     |
...
| Jump to:   | [[#Concept-Index_cp_letter-A][*A*]]   [[#Concept-Index_cp_letter-B][*B*]]   [[#Concept-Index_cp_letter-C][*C*]]   [[#Concept-Index_cp_letter-D][*D*]]   [[#Concept-Index_cp_letter-F][*F*]]   [[#Concept-Index_cp_letter-H][*H*]]   [[#Concept-Index_cp_letter-L][*L*]]   [[#Concept-Index_cp_letter-O][*O*]]   [[#Concept-Index_cp_letter-P][*P*]]   [[#Concept-Index_cp_letter-R][*R*]]   [[#Concept-Index_cp_letter-S][*S*]]   [[#Concept-Index_cp_letter-T][*T*]]   [[#Concept-Index_cp_letter-W][*W*]]   |
