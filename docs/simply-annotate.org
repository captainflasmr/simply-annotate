...
- [[#Advanced-Features][10 Advanced Features]]
  ...
  - [[#Cross_002dfile-Annotation-Browsing][10.2 Cross-file Annotation
    Browsing]]
  - [[#Annotation-Buffer-Features][10.3 Annotation Buffer Features]]
  - [[#Header_002dline-Integration][10.4 Header-line Integration]]
...
*** 10.2 Cross-file Annotation Browsing [[#Cross_002dfile-Annotation-Browsing][¶]]
:PROPERTIES:
:CUSTOM_ID: cross-file-annotation-browsing
:CLASS: section
:END:
To browse annotations across all files, bind =simply-annotate-show-all=
globally since it operates on the annotation database rather than the
current buffer:
...
*** 10.3 Annotation Buffer Features [[#Annotation-Buffer-Features][¶]]
:PROPERTIES:
...
*** 10.4 Header-line Integration [[#Header_002dline-Integration][¶]]
:PROPERTIES:
