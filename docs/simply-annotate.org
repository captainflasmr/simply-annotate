...
- [[#Display-Styles][7 Display Styles]]
  ...
  - [[#Inline-Display][7.5 Inline Display]]
...
:CLASS: chapter
:END:
Simply Annotate supports six different ways to display annotations,
...
<<Inline-Display>>
*** 7.5 Inline Display [[#Inline-Display][¶]]
:PROPERTIES:
...
(use-package simply-annotate
  ...
  (simply-annotate-display-style 'both) ; 'highlight, 'tint, 'fringe, 'fringe-bracket, 'both, or 'subtle
...
- <<index-simply_002dannotate_002ddisplay_002dstyle-1>>=simply-annotate-display-style=
  ...
  How to display annotations. Options: ='highlight=, ='tint=, ='fringe=,
  ='fringe-bracket=, ='both=, ='subtle=. Default: ='fringe=
