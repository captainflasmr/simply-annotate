...
- [[#Org_002dmode-Integration][12 Org-mode Integration]]
  - [[#Exporting-Annotations][12.1 Exporting Annotations]]
  - [[#Export-Format][12.2 Export Format]]
  - [[#Use-Cases-for-Export][12.3 Use Cases for Export]]
  - [[#Integration-with-Org-Workflows][12.4 Integration with Org
    Workflows]]
- [[#Key-Bindings][13 Key Bindings]]
  - [[#Mode-Map-_0028simply_002dannotate_002dmode_002dmap_0029][13.1
    Mode Map (=simply-annotate-mode-map=)]]
  - [[#Command-Map-_0028simply_002dannotate_002dcommand_002dmap_0029][13.2
    Command Map (=simply-annotate-command-map=)]]
  - [[#Annotation-Buffer-Bindings][13.3 Annotation Buffer Bindings]]
  - [[#Smart-Action-Behavior][13.4 Smart Action Behavior]]
  - [[#Sexp-Editing-Mode][13.5 Sexp Editing Mode]]
- [[#Customization][14 Customization]]
  - [[#Basic-Configuration][14.1 Basic Configuration]]
  - [[#Threading-and-Collaboration-Configuration][14.2 Threading and
    Collaboration Configuration]]
  - [[#Configuration-Examples][14.3 Configuration Examples]]
    - [[#Single-User-_0028Default_0029][14.3.1 Single User (Default)]]
    - [[#Code-Review-Team][14.3.2 Code Review Team]]
    - [[#Multi_002dProject-Consultant][14.3.3 Multi-Project Consultant]]
    - [[#Project_002dAware-Setup][14.3.4 Project-Aware Setup]]
  - [[#Core-Customization-Variables][14.4 Core Customization Variables]]
  - [[#Annotation-Level-Variables][14.5 Annotation Level Variables]]
  - [[#Threading-and-Collaboration-Variables][14.6 Threading and
    Collaboration Variables]]
  - [[#Custom-Faces][14.7 Custom Faces]]
  - [[#Display-Style-Configuration][14.8 Display Style Configuration]]
  - [[#Advanced-Customization][14.9 Advanced Customization]]
    - [[#Custom-Fringe-Bitmaps][14.9.1 Custom Fringe Bitmaps]]
    - [[#Global-Mode-Setup][14.9.2 Global Mode Setup]]
- [[#Data-Storage][15 Data Storage]]
  - [[#Storage-Format][15.1 Storage Format]]
  - [[#Sample-Storage-Format][15.2 Sample Storage Format]]
  - [[#Data-Structure-Evolution][15.3 Data Structure Evolution]]
  - [[#Data-Management][15.4 Data Management]]
  - [[#File-Key-System][15.5 File Key System]]
  - [[#Sexp-Editing-and-Data-Integrity][15.6 Sexp Editing and Data
    Integrity]]
- [[#Troubleshooting][16 Troubleshooting]]
  - [[#Annotations-Not-Persisting][16.1 Annotations Not Persisting]]
  - [[#Display-Issues][16.2 Display Issues]]
    - [[#Highlighting-Not-Visible][16.2.1 Highlighting Not Visible]]
    - [[#Fringe-Indicators-Not-Showing][16.2.2 Fringe Indicators Not
      Showing]]
  - [[#Smart-Action-Issues][16.3 Smart Action Issues]]
  - [[#Threading-Issues][16.4 Threading Issues]]
    - [[#Author-Prompting-Problems][16.4.1 Author Prompting Problems]]
    - [[#Thread-Display-Corruption][16.4.2 Thread Display Corruption]]
    - [[#Reply-Issues][16.4.3 Reply Issues]]
  - [[#Sexp-Editing-Issues][16.5 Sexp Editing Issues]]
    - [[#Parsing-Errors][16.5.1 Parsing Errors]]
    - [[#Data-Structure-Problems][16.5.2 Data Structure Problems]]
    - [[#Validation-Failures][16.5.3 Validation Failures]]
  - [[#Performance-with-Large-Files][16.6 Performance with Large Files]]
  - [[#Integration-Issues][16.7 Integration Issues]]
  - [[#Buffer_002dLocal-Variable-Issues][16.8 Buffer-Local Variable
    Issues]]
  - [[#Common-Error-Messages][16.9 Common Error Messages]]
  - [[#Getting-Help][16.10 Getting Help]]
...
** 12 Org-mode Integration [[#Org_002dmode-Integration-1][¶]]
:PROPERTIES:
...
*** 12.1 Exporting Annotations [[#Exporting-Annotations][¶]]
:PROPERTIES:
...
<<Export-Format>>
*** 12.2 Export Format [[#Export-Format][¶]]
:PROPERTIES:
...
*** 12.3 Use Cases for Export [[#Use-Cases-for-Export][¶]]
:PROPERTIES:
...
*** 12.4 Integration with Org Workflows [[#Integration-with-Org-Workflows][¶]]
:PROPERTIES:
...
** 13 Key Bindings [[#Key-Bindings-1][¶]]
:PROPERTIES:
...
*** 13.1 Mode Map (=simply-annotate-mode-map=) [[#Mode-Map-_0028simply_002dannotate_002dmode_002dmap_0029][¶]]
:PROPERTIES:
...
*** 13.2 Command Map (=simply-annotate-command-map=) [[#Command-Map-_0028simply_002dannotate_002dcommand_002dmap_0029][¶]]
:PROPERTIES:
...
*** 13.3 Annotation Buffer Bindings [[#Annotation-Buffer-Bindings][¶]]
:PROPERTIES:
...
*** 13.4 Smart Action Behavior [[#Smart-Action-Behavior][¶]]
:PROPERTIES:
...
<<Sexp-Editing-Mode>>
*** 13.5 Sexp Editing Mode [[#Sexp-Editing-Mode][¶]]
:PROPERTIES:
...
** 14 Customization [[#Customization-1][¶]]
:PROPERTIES:
...
<<Basic-Configuration>>
*** 14.1 Basic Configuration [[#Basic-Configuration][¶]]
:PROPERTIES:
...
*** 14.2 Threading and Collaboration Configuration [[#Threading-and-Collaboration-Configuration][¶]]
:PROPERTIES:
...
*** 14.3 Configuration Examples [[#Configuration-Examples][¶]]
:PROPERTIES:
...
**** 14.3.1 Single User (Default) [[#Single-User-_0028Default_0029][¶]]
:PROPERTIES:
...
<<Code-Review-Team>>
**** 14.3.2 Code Review Team [[#Code-Review-Team][¶]]
:PROPERTIES:
...
**** 14.3.3 Multi-Project Consultant [[#Multi_002dProject-Consultant][¶]]
:PROPERTIES:
...
**** 14.3.4 Project-Aware Setup [[#Project_002dAware-Setup][¶]]
:PROPERTIES:
...
*** 14.4 Core Customization Variables [[#Core-Customization-Variables][¶]]
:PROPERTIES:
...
*** 14.5 Annotation Level Variables [[#Annotation-Level-Variables][¶]]
:PROPERTIES:
...
*** 14.6 Threading and Collaboration Variables [[#Threading-and-Collaboration-Variables][¶]]
:PROPERTIES:
...
<<Custom-Faces>>
*** 14.7 Custom Faces [[#Custom-Faces][¶]]
:PROPERTIES:
...
*** 14.8 Display Style Configuration [[#Display-Style-Configuration][¶]]
:PROPERTIES:
...
*** 14.9 Advanced Customization [[#Advanced-Customization][¶]]
:PROPERTIES:
...
**** 14.9.1 Custom Fringe Bitmaps [[#Custom-Fringe-Bitmaps][¶]]
:PROPERTIES:
...
<<Global-Mode-Setup>>
**** 14.9.2 Global Mode Setup [[#Global-Mode-Setup][¶]]
:PROPERTIES:
...
** 15 Data Storage [[#Data-Storage-1][¶]]
:PROPERTIES:
...
<<Storage-Format>>
*** 15.1 Storage Format [[#Storage-Format][¶]]
:PROPERTIES:
...
*** 15.2 Sample Storage Format [[#Sample-Storage-Format][¶]]
:PROPERTIES:
...
*** 15.3 Data Structure Evolution [[#Data-Structure-Evolution][¶]]
:PROPERTIES:
...
<<Data-Management>>
*** 15.4 Data Management [[#Data-Management][¶]]
:PROPERTIES:
...
<<File-Key-System>>
*** 15.5 File Key System [[#File-Key-System][¶]]
:PROPERTIES:
...
*** 15.6 Sexp Editing and Data Integrity [[#Sexp-Editing-and-Data-Integrity][¶]]
:PROPERTIES:
...
*** 16.1 Annotations Not Persisting [[#Annotations-Not-Persisting][¶]]
:PROPERTIES:
...
<<Display-Issues>>
*** 16.2 Display Issues [[#Display-Issues][¶]]
:PROPERTIES:
...
**** 16.2.1 Highlighting Not Visible [[#Highlighting-Not-Visible][¶]]
:PROPERTIES:
...
**** 16.2.2 Fringe Indicators Not Showing [[#Fringe-Indicators-Not-Showing][¶]]
:PROPERTIES:
...
<<Smart-Action-Issues>>
*** 16.3 Smart Action Issues [[#Smart-Action-Issues][¶]]
:PROPERTIES:
...
<<Threading-Issues>>
*** 16.4 Threading Issues [[#Threading-Issues][¶]]
:PROPERTIES:
...
**** 16.4.1 Author Prompting Problems [[#Author-Prompting-Problems][¶]]
:PROPERTIES:
...
**** 16.4.2 Thread Display Corruption [[#Thread-Display-Corruption][¶]]
:PROPERTIES:
...
<<Reply-Issues>>
**** 16.4.3 Reply Issues [[#Reply-Issues][¶]]
:PROPERTIES:
...
<<Sexp-Editing-Issues>>
*** 16.5 Sexp Editing Issues [[#Sexp-Editing-Issues][¶]]
:PROPERTIES:
...
<<Parsing-Errors>>
**** 16.5.1 Parsing Errors [[#Parsing-Errors][¶]]
:PROPERTIES:
...
**** 16.5.2 Data Structure Problems [[#Data-Structure-Problems][¶]]
:PROPERTIES:
...
<<Validation-Failures>>
**** 16.5.3 Validation Failures [[#Validation-Failures][¶]]
:PROPERTIES:
...
*** 16.6 Performance with Large Files [[#Performance-with-Large-Files][¶]]
:PROPERTIES:
...
<<Integration-Issues>>
*** 16.7 Integration Issues [[#Integration-Issues][¶]]
:PROPERTIES:
...
*** 16.8 Buffer-Local Variable Issues [[#Buffer_002dLocal-Variable-Issues][¶]]
:PROPERTIES:
...
*** 16.9 Common Error Messages [[#Common-Error-Messages][¶]]
:PROPERTIES:
...
<<Getting-Help>>
*** 16.10 Getting Help [[#Getting-Help][¶]]
:PROPERTIES:
